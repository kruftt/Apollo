  ...
  <div id="header_bar">
    ...
    <div id="header_bar__title" class="noselect">
      ...
      <div id="apollo_live" @click="store.toggle_connection">
        ...
        <div id="apollo_live__status">&nbsp;{{ store.connection_status }}</div>
      </div>
    </div>
  </div>
</template>
...
.apollo_live__dot--searching { background-color: yellow }
.apollo_live__dot--connected { background-color: green }
